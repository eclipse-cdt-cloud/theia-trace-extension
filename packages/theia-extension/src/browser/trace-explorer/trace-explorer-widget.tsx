...
import { signalManager, Signals } from 'tracecompass-node/lib/signal-manager';
import { EditorManager, EditorOpenerOptions } from '@theia/editor/lib/browser';
import URI from '@theia/core/lib/common/uri';
import { Experiment } from 'tsp-typescript-client/lib/models/experiment';
import { ExperimentManager } from 'tracecompass-node/lib/experiment-manager';
...
export class TraceExplorerWidget extends ReactWidget {
    ...
    constructor(
       ...
       /* this.toDispose.push(signalManager().on(Signals.EXPERIMENT_OPENED, this.onExperimentOpened);
