...
import { listToTree, getAllExpandedNodeIds, getIndexOfNode, validateNumArray, getCollapsedNodesFromAutoExpandLevel } from './utils/filter-tree/utils';
...
export class TimegraphOutputComponent extends AbstractTreeOutputComponent<TimegraphOutputProps, TimegraphOutputState> {
    ...
    private onOrderReset = () => this.doHandleOrderReset();
