...
export type BaseGanttOutputProps = AbstractOutputProps & {
    menu_id: string;
...
export type BaseGanttOutputState = AbstractTreeOutputState & {
...
export abstract class BaseGanttOutputComponent<
    P extends BaseGanttOutputProps = BaseGanttOutputProps,
    S extends BaseGanttOutputState = BaseGanttOutputState
> extends AbstractTreeOutputComponent<P, S> {
    ...
    async componentDidUpdate(prevProps: BaseGanttOutputProps, prevState: BaseGanttOutputState): Promise<void> {
        if (
        ...
        return (
            <React.Fragment>
                <div
                    ...
                    style={{ height: 'auto' }}
                >
                    {this.renderBaseGanttContent(`${this.props.chartId}-content`)}
                </div>
    ...
    private renderBaseGanttContent(id: string) {
        return (
